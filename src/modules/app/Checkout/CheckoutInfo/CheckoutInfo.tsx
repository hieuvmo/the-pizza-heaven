...
export const CheckoutInfo: FC<CheckoutInfoProps> = ({ orderId }) => {
  ...
  const [ordinaryNumber, setOrdinaryNumber] = useState(0);
  ...
  const handleClickReviewFoodButton = (ordinalNumber: number) => {
    setOrdinaryNumber(ordinalNumber);
    setOpenModal(true);
  };
