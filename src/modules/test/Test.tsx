...
import { ORDER_TABLE_HEAD } from 'common/constants';
import { capitalizeFirstLetter } from 'common/helper/string';
import { IdOrderType, IOrderColumn } from 'common/types/table.mui.model';
    ...
    <Container maxWidth="lg" sx={{ paddingTop: '5rem' }}>
      <TableContainer component={Paper}>
        <Table aria-label="collapsible table">
          <TableHead>
            <TableRow>
              <TableCell sx={{ fontSize: '2rem' }} align="center" colSpan={9}>
                Order Management
              </TableCell>
            </TableRow>
            <TableRow>
